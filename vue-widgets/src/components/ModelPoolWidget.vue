...
import { useModelPoolState } from '../composables/useModelPoolState'
import { useModalState, type ModalType } from '../composables/useModalState'
import type { ComponentWidget, ModelPoolConfig } from '../composables/types'

// Props
const props = defineProps<{
  widget: ComponentWidget<ModelPoolConfig>
  node: { id: number }
}>()
...
onMounted(async () => {
  ...
  props.widget.callback = (v: ModelPoolConfig) => {
    if (v) {
  ...
  if (props.widget.value) {
    ...
    state.restoreFromConfig(props.widget.value as ModelPoolConfig)
  }
